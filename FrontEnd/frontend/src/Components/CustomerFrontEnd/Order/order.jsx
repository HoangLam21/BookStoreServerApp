...
export default function OrderCus() {
        ...
        <div className="img-book-placeholder h-80 w-60 bg-gray-200 flex items-center justify-center">
          No Image
                ...
                <div className="ml-5">
                  ...
                  <h6 className="text-color-main-2 text-xl font-garamond font-light">{item.author}</h6>
                  <h5 className="text-color-main mt-3 text-xl font-garamond font-light">{(item.total_pay).toLocaleString('vi-VN')} vnđ</h5>
                  <div className="flex mt-3">
                    <h4 className="text-color-main text-xl font-garamond font-light">Số lượng</h4>
                    <input className="text-color-main text-xl ml-10 font-garamond font-light w-10" type="number" value={item.quantity} min="0" />
                  </div>
                </div>
              </div>
            ))}
